...
var webName ="Byan Brone";
	//BarList
var navList =["Nature","People","Animal","Vechicle","Others"];
var subNavList1 = ["Others","Wedding","Birthday","Engagment","Ceremony"];
//Carousel
var imgNames = ["img1.jpg","img2.jpg","img3.jpg","img4.jpg","img5.jpg","img6.jpg"];
//PhotoBook
var imgCount=[8,6,1,8,36];
var Nature =5;
var NatureTitle =["Title1","Title2","Title3","Title4","Title5"];
var NatureText=["SomeOther Text","SomeOther Text","SomeOther Text","SomeOther Text","SomeOther Text"];
var People =10;
var Animal =12;
//Footer
...
function insertNavList(eID, list){
	...
	for(var i = 0;i<list.length;i++){
		navText = navText + "<li id='navID"+(i)+"' class='nav-item'><a class='nav-link' href='#" +list[i] +"'>"+ list[i] +"</a></li>";
	...
	for (var i = 0; i < list.length; i++) {
		...
		for (var m = 0; m < list2[i]; m++) {
			...
			for (var t = 0; t < list2[i]; t++) {
				...
				imgContent.setAttribute("src","images/"+list[i]+"/img ("+(t+1)+").jpg");
